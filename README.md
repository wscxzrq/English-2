...
1. **ion / ment: 表示行为、过程或行为的结果**
   ...
   1. <font color="#F56C6C">v.</font> + tion $\rightarrow$ n. (有e去e) 动词变为名词
...
<font color="#F56C6C">Money</font> is important (主语句首)

I have <font color="#F56C6C">money</font> (动词后面)

I have <font color="#F56C6C">a</font> house (可位于<font color="#F56C6C">冠词后</font>)

I have a <font color="#F56C6C">big</font> house (可位于<font color="#F56C6C">形容词后</font>)

a an the 是冠词，其中 a  an 属于不定冠词

You can call me <font color="#F56C6C">Via</font> (句尾宾补)

Via has a <font color="#F56C6C">mountain</font> bike (名词修饰名词)

Via rode the mountain bike <font color="#F56C6C">yesterday</font> (句尾状语)

Via will sell the mountain bike to her <font color="#F56C6C">neighbour</font> (间接宾语)
...
1. **不规则变化**
   ...
   5. 合成名词：主体名词变复数，如果没有主体名词则将最后一个部分变为复数,
      ...
      **特例**：==性别==加==职业== 统一全都变复数
      ...
      The number of <font color="#F56C6C">women</font> (woman) doctors in the hospital <font color="#F56C6C">has</font> (have) increased dramatically over the past decade.
      
      women doctors 性别 + 职业，统一用复数形式
...
1. **物质名词**
   ...
   <font color="#F56C6C">无法量化的 不能与 a/an 连用</font>，如果需要量化则需要加单位

   液体 water + 单位 a ==glass/bottle== of water 一杯水或一瓶水

    气体 air + 单位 a ==can== of air 一罐空气

   肉类 pork + 单位 a ==slice== of pork 一片肉

   粉末 sand + 单位 a ==bag== of salt 一袋盐

   <font color="#F56C6C">有些名词可加s，表示不同含义</font>
...
2. **抽象名词**
   ...
   <font color="#F56C6C">看不见、摸不着 不能与a/an 连用</font>
   ...
   **特例**：**experience**
   ...
   1. The teachers met once a year to exchange <font color="#F56C6C">experience</font>

      老师们每年聚会一次交流经验。

   2. My life in China was <font color="#F56C6C">an</font> unforgettable <font color="#F56C6C">experience</font>

      我在中国的生活是一段难忘的经历。

      I have many unforgettable <font color="#F56C6C">expericnces</font> in China

      我在中国有许多难忘的经历

### 描述数量-可数/不可数

1. 只能修饰<font color="#F56C6C">可数名词</font>：many, a number of, a few, few
2. 只能修饰<font color="#F56C6C">不可数名词</font>：much, a deal of, a little, little
3. 都可：some, any, a lot of, lots of, plenty of

I have <font color="#F56C6C">a little</font> money left

我还剩一点钱

I have <font color="#F56C6C">little</font> money left

我剩下的钱不多了

## 主谓一致

我<font color="#F56C6C">是</font>一个女孩	I <font color="#F56C6C">am</font> a  girl

你<font color="#F56C6C">是</font>一个女孩	You <font color="#F56C6C">are</font> a girl

她<font color="#F56C6C">是</font>漂亮的	She <font color="#F56C6C">is</font> beautiful
...
1. happy 的反义词为
   1. <font color="#F56C6C">unhappy</font>
   2. inhappy
   3. dehappy
   4. ilhappy
...
2. sandness 意思是
   ...
   1. 极速进行
   2. 规则
   3. <font color="#F56C6C">悲哀</font>
   4. 房间

3. rule 意思是

   1. 极速进行
   2. <font color="#F56C6C">规则</font>
   3. 房间
   4. 悲哀
...
4. fact 意思是
   ...
   1. 胖的
   2. <font color="#F56C6C">事实</font>
   3. 故事
   4. 满意

5. experience 的意思是

   1. <font color="#F56C6C">经历</font>
   2. 花费
   3. 专家
   4. 延伸
...
6. 下列选项中表示“演讲者”的是
   ...
   2. speak
   3. speaking
   4. <font color="#F56C6C">speaker</font>

7. 单词 "hope"的副词形式是

   1. hopeful
   2. <font color="#F56C6C">hopefully</font>
   3. hoping
   4. hopeless
...
8. potato 的复数为
   ...
   1. potatos
   2. <font color="#F56C6C">potatoes</font>
   3. potatoos
   4. potatooes
...
9. growth 的意思是
   ...
   2. 减少
   3. 平衡
   4. <font color="#F56C6C">增长</font>

10. plant 的意思是

    1. 计划

    2. <font color="#F56C6C">植物</font>
...
13. violence 的意思是
    ...
    2. 邪恶
    3. 花瓶
    4. <font color="#F56C6C">暴力</font>

14. building 的中文意思是

    1. <font color="#F56C6C">建筑</font>
    2. 货车
    3. 桥梁
    4. 预算
